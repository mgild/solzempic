...
pub fn SolzempicEntrypoint(attr: TokenStream, item: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        ...
        #[ignore]
        fn write_idl() {
            // Convert program ID to base58 string
